...
renderedPageRouter.get('*', (req, res) => {
    match({ routes, location: req.url }, (error, redirectLocation, renderProps) => {
        if (error) {
            ...
            // console.log('componentsWithData: ' + componentsWithData);
            ...
            // console.log('dataFetchers: ' + dataFetchers);
            Promise.all(dataFetchers).then((dataList) => {
                // console.log('DATALIST: ' + dataList);
                let initialState = {};
                dataList.forEach((nameData) => {
                    initialState = Object.assign(initialState, nameData);
